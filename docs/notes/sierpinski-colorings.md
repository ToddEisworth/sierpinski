...
!!! proof
    ...
    $n!(n-1)!$ possible values. We borrow the following lemma from
    MR4579382:
    ...
    which each level has exactly one splitting node. This is easier to show
    ...
    !!! example
        ...
        For example, the abstract splitting pattern
...
![A skew binary tree with splitting levels](../images/skew-binary-tree.svg)
